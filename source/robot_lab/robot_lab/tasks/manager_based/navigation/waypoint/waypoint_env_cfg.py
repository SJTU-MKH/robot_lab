...
import robot_lab.tasks.manager_based.navigation.waypoint.mdp as mdp

##
# Pre-defined configs
##
from .boxgarden_terrain_cfg import BOXGARDEN_TERRAIN_CFG  # isort: skip
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=BOXGARDEN_TERRAIN_CFG,
...
@configclass
class NavigationWaypointBoxGardenEnvCfg(ManagerBasedRLEnvCfg):
