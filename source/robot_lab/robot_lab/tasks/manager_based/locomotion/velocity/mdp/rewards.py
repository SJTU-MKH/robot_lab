...
def track_base_height_exp(
    ...
    """Reward tracking of base height command using exponential kernel.

    The height command is stored in the heading field (index 2) of the command.
    """
    # extract the used quantities (to enable type-hinting)
    asset: RigidObject = env.scene[asset_cfg.name]
    # get target height from command (stored in heading field)
